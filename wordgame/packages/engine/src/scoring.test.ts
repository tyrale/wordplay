...
describe('Scoring Module', () => {
  describe('scoreTurn', () => {
    ...
    it('should score letter addition at end', () => {
      const actions = [
        { type: 'ADD' as const, letter: 'S', position: 3 }
      ];
    ...
    it('should score letter addition in middle', () => {
      const actions = [
        { type: 'ADD' as const, letter: 'O', position: 1 }
      ];
    ...
    it('should score letter addition at start', () => {
      const actions = [
        { type: 'ADD' as const, letter: 'S', position: 0 }
      ];
    ...
    it('should score letter removal from end', () => {
      const actions = [
        { type: 'REMOVE' as const, letter: 'T', position: 2 }
      ];
    ...
    it('should score letter removal from middle', () => {
      const actions = [
        { type: 'REMOVE' as const, letter: 'A', position: 1 }
      ];
